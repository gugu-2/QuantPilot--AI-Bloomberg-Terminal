...
AboutScreen::AboutScreen(QWidget* parent) : QWidget(parent) {
    ...
    // ── Resources — 3×2 grid ─────────────────────────────────────────────────
    {
        ...
        const Link links[] = {
            {"GitHub Repository", "https://github.com/QuantPilot-App/QuantPilot"},
            {"License (AGPL-3.0)", "https://github.com/QuantPilot-App/QuantPilot/blob/main/LICENSE"},
            {"Commercial License",
             "https://github.com/QuantPilot-App/QuantPilot/blob/main/docs/COMMERCIAL_LICENSE.md"},
            {"Trademark Policy", "https://github.com/QuantPilot-App/QuantPilot/blob/main/docs/TRADEMARK.md"},
            {"Contributor CLA", "https://github.com/QuantPilot-App/QuantPilot/blob/main/docs/CLA.md"},
