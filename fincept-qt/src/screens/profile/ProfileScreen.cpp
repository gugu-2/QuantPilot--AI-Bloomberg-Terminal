...
QWidget* ProfileScreen::build_support() {
    ...
    make_link_btn(tr("DOCS"), "https://github.com/QuantPilot-App/QuantPilot/tree/main/docs");
    make_link_btn(QStringLiteral("GITHUB"), "https://github.com/QuantPilot-App/QuantPilot");
    make_link_btn(QStringLiteral("DISCORD"), "https://discord.gg/ae87a8ygbN");
    make_link_btn(tr("FAQ"), "https://github.com/QuantPilot-App/QuantPilot/wiki");
    lrl->addStretch();
    lvl->addWidget(lr);
    vl->addWidget(lp);
    vl->addStretch();
