...
#include "screens/wallet/PortfolioScreen.h"
...
void WindowFrame::setup_dock_screens() {
    ...
    dock_router_->register_factory("plugin_dashboard", []() { return new screens::PluginDashboardScreen; });
    dock_router_->register_factory("alt_data", []() { return new screens::AltDataHubScreen; });
    dock_router_->register_factory("marketplace", []() { return new screens::CommunityMarketplaceScreen; });
    dock_router_->register_factory("copilot", []() { return new screens::CopilotBar; });

    // Ensure all factories are registered above this line
    ...
    dock_router_->register_factory("agent_action_center", []() { return new screens::AgentActionCenter; });
